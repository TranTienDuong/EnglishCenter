      ...
      <div className="container mx-auto py-12 px-4">
        <div className={styles.footerGrid}>
          <div className={styles.footerColumn}>
            <h3 className={styles.footerTitle}>IELTS Center</h3>
          ...
          <div className={styles.footerColumn}>
            <h3 className={styles.footerHeading}>Khóa học</h3>
            <ul className={styles.footerLinks}>
              <li><a href="#courses" className={styles.footerLink}>IELTS mất gốc</a></li>
              <li><a href="#courses" className={styles.footerLink}>IELTS cấp tốc</a></li>
              <li><a href="#courses" className={styles.footerLink}>IELTS 1 kèm 1</a></li>
              <li><a href="#courses" className={styles.footerLink}>IELTS 7.0+</a></li>
              <li><a href="#courses" className={styles.footerLink}>IELTS 6.0-6.5</a></li>
              <li><a href="#courses" className={styles.footerLink}>IELTS 5.0-5.5</a></li>
            </ul>
          </div>
          
          <div className={styles.footerColumn}>
            <h3 className={styles.footerHeading}>Liên kết</h3>
            <ul className={styles.footerLinks}>
              <li><a href="#" className={styles.footerLink}>Về chúng tôi</a></li>
              <li><a href="#" className={styles.footerLink}>Đội ngũ giáo viên</a></li>
              <li><a href="#" className={styles.footerLink}>Lịch học</a></li>
              <li><a href="#" className={styles.footerLink}>Blog</a></li>
              <li><a href="#" className={styles.footerLink}>Tài liệu IELTS</a></li>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.contactInfo}>
              ...
              <li className={styles.contactItem}>
                <span className={styles.contactIcon}>📞</span>
                <span className={styles.contactText}>0987.654.321</span>
              </li>
              <li className={styles.contactItem}>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>© {new Date().getFullYear()} IELTS Center. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
